...
# Releasing cmem-plugin-sparql-anything
...
Then watch the publish workflow at https://github.com/eccenca/cmem-plugin-sparql-anything/actions and confirm the
new version appeared on [PyPI](https://pypi.org/project/cmem-plugin-sparql-anything/).
